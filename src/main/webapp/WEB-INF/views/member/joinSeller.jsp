...
<body>
	...
	<div style ="padding: 5px 50px 5px 50px;">
		...
		<div style="font-size:13px">
			&nbsp;
			<input type="checkbox" name="agree1" id="agree1">구매이용약관
			<a href="#buy" style="font-size:10px; background-color: #CEFFC7;">본문보기</a>
			<br>
			&nbsp;
			<input type="checkbox" name="agree2" id="agree2">판매이용약관
			<a href="#sell" style="font-size:10px; background-color: #CEFFC7;">본문보기</a>
			<br>
			&nbsp;
			<input type="checkbox" name="agree3" id="agree3">개인정보 수집 및 이용에 대한 안내
			<a href="#info" style="font-size:10px; background-color: #CEFFC7;">본문보기</a>
		</div>
		
		<br><br>
	   	<div style="text-align:center">
	 	 	<input type="button" value="동의하고 가입하기" onclick="doSignupSeller()" class="button button1">
		</div>
		<br><br>
		<a name="buy"></a>
		<b>[필수] 구매이용약관 동의</b><br>
...
제1조 (목적)
이 약관은 십일번가 주식회사(이하 "회사")가 운영하는 11번가(http://www.11st.co.kr 및 m.11st.co.kr, 이하 "11번가"), 글로벌11번가(http://global.11st.co.kr 및 글로벌11번가 모바일 어플리케이션, 이하 "글로벌11번가")와 11번가가 입점한 해외사이트(http://11street.jd.hk/, 이하 "해외입점11번가")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 상품 또는 용역을 거래하는 자 간의 권리, 의무 등 기타 필요사항, 회원과 회사간의 권리, 의무, 책임사항 및 회원의 서비스 이용절차 등에 관한 사항을 규정함을 목적으로 합니다.
 
제2조 (용어의 정의)
① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
1. 11번가: 자유로운 상품 또는 용역(이하 "상품")의 거래를 위하여 회사가 제공하는 실시간 전자상거래 시스템과 그 운영을 위한 웹사이트를 말합니다.
...
나. 셀러회원(구매판매고객): 11번가에서 상품 구매 및 관련 서비스와 판매회원약관(이하 "판매이용약관")상의 서비스를 이용할 수 있는 회원을 말합니다. 셀러회원은 개인셀러회원과 사업자셀러회원으로 구분됩니다.
...
8. 구매자: 회사에 등록된 판매자의 상품을 구매하는 자를 말하며, 일반회원과 셀러회원, 비회원에게 모두 구매자격이 부여 됩니다.
...
12. 캐시: 11번가에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유로 환불을 요청했을 때 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려워 회사가 회원에게 환불해야 하는 현금 환불수단으로 활용되는 정보를 말합니다.
13. 구매확정기간: 구매자가 거래에 대하여 구매 종료(구매확정, 반품, 교환)의 의사표시를 해야 하는 기간으로, 물품수령일로부터 7일이 되는 날(설치상품 등 물품수령일을 확인할 수 없을 때에는 발송완료일로부터 21일이 되는 날을 물품수령일로 간주하고 그로부터 7일이 되는날)까지를 말합니다.
...
18. 분쟁조정센터: 11번가를 통한 거래에서 분쟁이 발생하면 판매자와 구매자가 자율적으로 해결하는 것이 원칙이지만, 분쟁의 합리적이고 원활한 조정을 위하여 예외적으로 회사가 설치·운영하는 분쟁조정기구를 말합니다.
② 제1항에서 정의되지 않은 용어의 의미는 관련 법령 및 일반적인 거래관행을 따릅니다.
 
제3조 (적용 범위 및 효력 우선순위)
① 이 약관에서 제1장(총칙), 제3장(기타사항)은 전체 서비스에 적용되며, 제2장은 11번가(통신판매중개) 서비스에 구분하여 적용됩니다.
② 제1장 및 제3장의 규정과 개별서비스인 제2장의 규정이 상충할 때에는 개별서비스 관련 규정(제2장)이 전체서비스 관련 규정(제1장 및 제3장)보다 우선적인 효력을 갖습니다.
 
제4조 (약관의 명시, 효력 및 변경)
① 회사는 정의된 약관을 이용자가 알 수 있도록 회사의 서비스가 제공되는 인터넷 사이트 (http://www.11st.co.kr)의 첫 화면에 게시합니다.
② 회사는 합리적인 사유가 발생하면 약관의 규제에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령에 위배되지 않는 범위 안에서 이 약관을 변경 할 수 있으며, 회사가 약관을 변경할 때에는 적용일자와 변경사유를 밝혀 그 적용일자 15일 전부터 서비스 사이트에 공지합니다. 다만, 이용자에게 불리한 약관을 변경할 때에는 해당 내용을 그 적용일자 30일 전부터 공지하며, 이메일(e-mail), 문자메시지(SMS) 등으로 이용자에게 개별 통지합니다(이용자의 연락처 미기재, 변경 등으로 개별 통지가 어려울 때에는 본 약관에 따라 공지를 하는 것을 개별 통지한 것으로 간주합니다).
...
② 회사는 필요하면 특정 서비스에 적용될 사항(이하 “개별약관”)을 정하여 이를 11번가 등을 통하여 공지할 수 있습니다.
③ 회사는 필요하면 서비스 이용과 관련된 세부적인 내용(이하 "이용정책")을 정하여 이를 11번가 등을 통하여 공지할 수 있습니다.
④ 개별약관이나 이용정책의 변경이 있으면 회사는 변경 내용의 효력발생일 7일 이전에 11번가를 통하여 해당 변경 사항을 공지합니다.
...
④ 개인구매회원은 다수의 아이디(ID)를 생성하여 사용할 수 있으나, 구매서비스 이용은 최초 본인확인된 1개 아이디(ID)에 한하여 가능합니다. 셀러회원은 본인 1인(본인확인 기준, 법인사업자와 개인사업자의 경우에는 각각 법인번호, 사업자번호 기준)당 1개 아이디(ID)를 사용하는 것을 원칙으로 합니다. 단, 사업자셀러회원 중 회사가 정하는 기준(거래기간, 실적, 신용도, 분쟁내용 등)을 충족하는 셀러회원에게는 사업자등록번호 1개당 5개까지의 회원 아이디(ID)를 부여할 수 있습니다.
...
⑥ 11번가에서 제공하는 서비스를 통하여 거래가 성사 되었을 때 회사는 판매자와 구매자 간에 물품거래와 배송 등의 이행과 관련하여 필요한 범위 내에서 구매자의 개인정보를 판매자에게 제공합니다.
 
제8조 (서비스 이용 신청)
① 회사가 제공하는 서비스에 가입 하여 이용하고자 하는 자는 회사에서 제공한 회원가입 신청양식에 따라 필요사항을 기재하여야 합니다. 회원가입 양식은 필수 기재 항목과 선택 기재 항목으로 구분 되어 있으며 필수 기재 항목은 반드시 입력 해야 합니다. 회원가입 신청양식의 각 필요사항은 이용신청자가 개인 또는 사업자인지에 따라 달리 적용됩니다.
② 개인구매회원과 개인셀러회원의 필수 기재 항목: 회원아이디 (ID), 비밀번호(Password), 성명, 생년월일, 이메일(E-mail)주소, 휴대전화번호의 항목을 기재해야 합니다.
③ 사업자셀러회원의 필수 기재 항목: 사업자 유형, 회원아이디(ID), 비밀번호(Password), 상호(사업체명), 대표자 성명, 사업자등록번호, 이메일 주소, 대표자 연락처, 팩스번호, 사업장 소재지, 상품판매대금 송금계좌번호, 업태, 종목, 법인등록번호, 통신판매업신고번호, 대표 카테고리의 항목을 기재해야 합니다.
④ 사업자는 사업자회원으로 가입신청을 하여야 하며, 사업자회원으로 가입하고자 하는 자는 회사의 요청에 따라 사업자등록증 사본, (개인사업자의 경우)대표자의 신분증 사본, 법인등기부등본, 법인인감증명서, 결제를 위한 대표자 또는 법인명의의 계좌정보 등의 증빙자료와 추가 정보를 제공하여야 합니다.
⑤ 회사는 이용자의 회원 가입 시 제1항 또는 제2항에 표시된 필수항목 외에 추가적인 정보(예: 성별, 유선전화번호 등)를 요청할 수 있으며, 이용신청자는 그러한 추가적인 정보의 제공을 거절할 수 있습니다. 추가적인 정보는 회원에게 다양하고 유익한 정보를 제공하기 위해서만 사용되며 그 밖의 목적으로 사용할 수 없습니다.
...
② 회사는 개인셀러회원의 가입신청에 대해서는 법령에 따라 이용 할 수 있는 본인확인기관을 통하여 본인 여부를 확인하는 방식의 본인확인절차를 이행하며, 사업자회원의 가입신청에 대해서 제8조 제4항에 따라 제공받은 증빙자료 등으로 본인확인절차를 이행합니다. 회사는 본인확인절차를 이행할 수 없는 이용신청에 대해서는 신청자에게 증빙자료를 요청할 수 있습니다.
...
1. 회원은 언제든지 회사에 해지의 의사를 통지하여 이용계약을 해지할 수 있습니다. 단, 해지의사를 통지하기 전에 현재 진행 중인 모든 상품의 거래를 완료하거나 철회 또는 취소하여야 하며, 거래의 철회 또는 취소로 인한 불이익은 회원 본인이 부담하여야 합니다. 또한, 회원이 회사에 대한 채무를 전부 이행(마이너스 마일리지의 상환 등)하지 않으면 회원이 해당 채무를 전부 이행할 때까지 회사는 회원의 이용계약 해지를 제한할 수 있으며, 회원이 이 약관과 관계 법령 등을 위반하여 이용이 정지된 경우 회사가 재발방지를 위하여 회원의 이용계약 해지를 제한할 수 있습니다.
...
가. 회원의 의사로 이용 계약을 해지한 경우 : 1개월 (단, 탈퇴 시 판매회원의 지위도 동시에 가졌던 경우에는 2개월)
...
제11조 (회원등급 및 평가제도)
① 회사는 서비스를 이용하여 상품을 거래했을 때 부과되는 점수를 기준으로 하여 회원등급 및 등급에 따른 일정 혜택 등을 회원에게 부여할 수 있습니다. 회원등급 및 그에 따른 혜택 등은 서비스 이용실적, 기타 회사가 정하는 이용정책에서 정한 기준에 따라 부여되며, 자세한 내용은 해당 서비스 화면에 게재하거나 회사가 운영하는 인터넷 사이트 초기화면에 공지합니다(회원등급 정책 및 그에 따른 혜택 등에 대한 변경이 있으면 이 약관 제5조 제4항에 따라 변경 공지합니다).
...
⑤ 상품평은 상품을 구매한 구매자가 작성할 수 있으며 공개를 원칙으로 합니다. 상품평 작성자는 자신이 작성한 상품평을 삭제할 수 있습니다. 상품평과 첨부된 의견의 내용이 욕설, 비방, 명예훼손 등의 내용이거나 상품 평가와 무관한 내용을 담고 있어 공개가 부적절하다고 판단되면,회사는 해당 상품평과 첨부된 의견을 삭제할 수 있습니다. 다만 상품에 대한 불만, 판매자에게 불리한 내용이라는 이유만으로는 삭제하지 않습니다. 상품평을 삭제할 때에는 상품평에 첨부된 의견도 함께 삭제됩니다. 이와 관련한 자세한 내용은 본 이용약관과 해당 서비스 화면에 게재합니다.
...
제13조 (서비스 기간과 중단)
① 회원의 서비스 기간은 11번가에 서비스를 신청하여 이용승낙을 받은 날로부터 서비스 이용계약을 해지할 때까지 입니다.
...
제14조 (서비스 이용료)
회사는 11번가의 일부 특정 서비스나 기능을 제공할 때 이용료를 부과할 수 있으며, 그 상세한 내용은 개별 약관, 별도 신청서를 통해 정할 수 있습니다.
...
제16조 (포인트, 캐시)
① 11번가에서 회원이 무통장입금, 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유가 발생하면 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어렵거나 회원의 설정으로 인하여 회사는 회원에게 캐시를 이용하여 회원에게 환불해 줄 수 있습니다. 이 때, 캐시는 현금출금만 가능하며, 캐시 1원은 현금 1원의 의미가 있습니다.
...
④ 본 조 제3항에 언급된 회사의 사용권은 11번가 서비스를 운영하는 동안에만 확정적으로 유효합니다.
...
⑦ 이용자가 11번가를 이용하여 얻은 정보를 회사의 승낙 없이 복제, 송신, 출판, 배포, 방송, 기타 방법으로 이용하거나 제3자에게 이용하게 할 때 그에 대한 책임은 이용자 본인에게 있습니다.
⑧ 회원은 11번가 내에서 자신의 저작권이 침해되면 회사가 운영하는 신고센터 제도를 이용하여 자신의 정당한 권리를 보호받을 수 있습니다.
...
5. 기타 제1호 내지 제4호에 준하는 중대한 사유로 말미암아 회사가 제공하는 11번가 서비스의 원활한 진행을 방해하는 것으로 판단되는 경우
...
1. E-Commerce 서비스: 회사가 인터넷사이트(http://www.11st.co.kr)를 통하여 회원 간에 상품의 매매가 이루어질 수 있도록 온라인 거래장소를 제공하는 서비스 및 관련 부가서비스를 말합니다.
가. 판매 관련 업무지원 서비스
나. 구매 관련 지원 서비스
다. 계약체결, 결제 지원 및 결제대금 보호 서비스
라. 상품검색정보 서비스
마. 기타 전자상거래 관련 서비스
바. 11번가 광고 및 프로모션 서비스
...
② 회사는 11번가를 통하여 이루어지는 구매자와 판매자 간의 거래와 관련하여 판매의사 또는 구매의사의 존부 및 진정성, 등록 상품의 품질, 완전성, 안정성, 적법성 및 타인의 권리에 대한 비침해성, 구매자 또는 판매자가 입력하는 정보 및 그 정보를 통하여 링크된 URL에 게재된 자료의 진실성 또는 적법성 등 일체를 보증하지 않습니다. 다만, 등록된 상품 관련 정보가 법규 위반이나 저작권 침해가 명백한 경우, 또는 저작권 등 권리를 침해받았다고 주장하는 자가 그 침해의 정지ㆍ예방을 요청하는 경우 회사는 당사자간의 분쟁이 해결되어 권리관계가 명확해질 때까지 해당 상품에 대한 삭제, 수정 또는 미노출 처리할 수 있습니다.
...
③ 구매자는 상품의 상세 내용과 거래의 조건 등에 관한 내용을 판매자에게 확인하기 위하여 회사가 제공하는 1:1 메신저 서비스를 이용할 수 있습니다. 해당 서비스를 통한 대화 내용은 대화 당사자가 동시에 대화 진행 불가 시 대화 내용 유지 등 원활한 서비스 제공을 위해 암호화되어 저장되며 회사는 해당 서비스 이용 목적 외 이를 사용하지 않습니다.
...
⑬ 회사가 구매자의 서비스 이용 편의를 높이기 위해 제휴업체로부터 정보를 제공받아 게재하거나 제3자가 제공하는 방식으로 11번가 사이트 내 또는 링크 방식으로 참조용 정보나 콘텐츠를 제공할 수 있으며, 구매자는 상품 구매 때 자신의 판단과 책임으로 결정하여 구매하여야 합니다.
...
② 결제대금 보호 서비스는 11번가에서 구매하는 모든 상품에 적용 됩니다.
...
④ 구매확정 기간 내에 구매자에게서 구매확정, 교환 또는 반품에 대한 의사표시가 없으면 회사는 해당 거래에 대하여 구매확정의 의사가 있는 것으로 간주하여 다음 영업일에 자동구매확정으로 처리(이하 “자동구매확정”)할 수 있습니다. 다만, 구매확정 기간 내에 구매자가 실제 상품을 수령하지 못했다면 구매자는 상품 미도착 신고를 할 수 있습니다.
...
⑨ 실제 상품의 배송이 없거나 회사가 제공하는 쿠폰 등의 유효기간을 연장하기 위한 목적으로 구매와 취소를 반복하는 등 상품의 실질적인 구매의사가 없는 구매행위와 회사가 제공하는 할인율 등을 이용하여 비정상적인 거래를 하는 것은 금지되며, 해당 내용이 확인되면 회사는 해당 거래를 취소하고 서비스이용을 제한하거나 이용계약을 해지할 수 있습니다.
⑩ 제3자에게 재판매하기 위한 목적으로 회사가 제공하는 혜택이나 할인률 등을 부당하게 이용하는 행위(다른 오픈마켓이나 인터넷쇼핑몰 등에 임의로 최저가를 등록하는 등으로 11번가 할인쿠폰 발행을 유도한 후 해당 쿠폰을 적용하여 구매하는 행위 등), 회사에 손실을 발생시키는 행위는 금지되며, 재판매 목적의 거래행위가 확인된 경우 회사는 해당 회원에 대하여 서비스이용제한, 이용계약의 해지 등의 조치를 취할 수 있으며, 이러한 행위로 손해가 있을 경우 배상을 청구할 수 있습니다.
...
⑫ 회사는 구매회원의 부정 거래 행위(현금융통, 결제수단도용, 대량 허위거래 등)가 의심되면 일시적으로 서비스 이용을 정지하고 거래 사실 확인 및 소명을 위해 정지한 날로부터 15일 이내에 필요 최소한의 증빙자료(거래사실증명서, 물품 수급 및 발주, 배송증빙서류 등)를 요청 할 수 있습니다. 만약 특별한 사정없이 회사가 요청한 증빙자료를 정해진 기한 내에 제출하지 않거나 서류 미비 또는 소명이 되지 않을 경우 서비스 이용이 영구히 정지되거나 이용계약이 해지될 수 있습니다.
...
⑥ 해외쇼핑 11번가에서 판매되는 상품 가격에는 관세와 부가세(이하 ’관부가세’)가 포함되어 있을 수 있으며, 관부가세가 포함되어 있지 않은 상품에도, 상품 종류, 가액, 구매 목적(국내 판매 목적 구매 등) 등에 따라 추후 관부가세가 부과될 수 있으며, 이와 관련하여 관세청으로부터 수입신고 절차 및 관부가세 납부 절차의 통지를 받으실 수 있습니다.
⑦ 수입대행자인 글로벌셀러가 관세법에 따라 제6항의 수입신고를 대행하는 경우 관세법 등 관련 법령에 따라 회사는 글로벌셀러가 수입을 대행하는 데 필요한 구매자의 통관정보를 글로벌셀러로부터 위탁 받아 수집할 수 있습니다.
⑧ 본 조에서 달리 규정된 사항을 제외하고는, 해외쇼핑 11번가를 이용하는 데도 이 약관의 제반 내용이 동일하게 적용됩니다.
...
1.“글로벌11번가” 상품: 셀러회원이 등록한 가격 정보를 “회사”의 환율 기준에 따라 구매자에게 노출되고, “회사”는 11번가 판매이용약관의 전세계배송 이용특약에 따라 셀러회원에게 정산함
2. “해외입점11번가” 상품: “회사”는 “해외입점11번가”가 입점한 국가에서 판매를 촉진하기 위해 해당 국가 플랫폼의 운영 정책에 따라 셀러회원이 등록한 가격에 관세, 배송비 등을 추가 포함한 통합 가격을 설정하여 “회사”의 환율 기준에 따라 구매자에게 노출할 수 있으며, “회사”는 11번가 판매이용약관의 전세계배송 이용특약에 따라 셀러회원에게 정산함
③ 전세계 배송의 경우, 구매자는 상품수령 후 7일 이내에 단순 변심으로 인한 교환/반품 신청이 가능하며 교환/반품으로 발생하는 비용(왕복 국내배송비 및 해외배송비 등)은 구매자가 부담해야 합니다.(단, 주문한 전 상품이 물류센터에 입고되어 합포장이 완료된 이후에는 고객센터를 통해 요청해야 합니다) 또한, 상품에 하자가 있거나 잘못된 상품이 배송되었을 때에는 구매확정 후 고객센터를 통해 관련 증빙자료를 제출해 주셔야 반품/교환 접수가 가능합니다. 접수 후 상품을 발송할 때에는 해외배송망(특송사 및 운송장번호 등)에 대한 정보를 고객센터를 통해 알려주셔야 합니다.
④ 전세계배송 서비스를 이용하여 상품을 구매했을 때, 주문 시 결제한 예상 해외배송비보다 실제 무게로 책정된 해외배송비가 적으면 회원이 결제했던 원결제 수단 또는 11번가가 지정한 보조결제수단으로 환급됩니다. 예상 해외배송비보다 실제 무게로 책정된 해외배송비가 크면 추가 해외배송비를 결제해 주셔야 합니다.(단, 1천원 미만이면 결제하지 않아도 됨) 추가 해외배송비를 14일 이상 결제하지 않으면 주문하신 상품은 판매자에게 자동으로 반품되며, 이 때 국내 반품에 드는 비용을 결제해 주셔야 구매금액이 환불됩니다.
...
⑥ 판매자의 책임있는 사유로 국내 통관이 거부되는 경우, 판매자는 이 때문에 국내 반품에 드는 비용을 부담하여야 합니다. 또한, 국내 통관이 거부된 상품은 자동으로 판매자에게 반품으로 신청되고, 나머지 주문상품은 해외로 배송 됩니다. 상품의 국내 통관이 거부되었을 때에는 상품가격과 해당 무게만큼의 해외 배송비를 환불해 드립니다.
⑦ 현지 국가의 해외 통관 거부, 주소지 불명, 수취인 거부(관세거부 포함)에 의한 반송은 구매자 귀책으로 간주하며, 이로 인해 발생하는 국내, 해외 배송비 등은 구매자가 부담합니다. 반송되는 상품들은 회사의 물류센터에서 최대 90일까지만 보관하며, 90일 내 구매자와 연락이 되지 않거나, 구매자 수취거부 시 상품의 성질, 형질의 변형 등의 사정으로 판매자가 회수하기 곤란한 경우 환불이 제한되거나 불가할 수 있습니다. 해외 통관 시 압수, 폐기된 상품에 대해서는 재배송과 환불이 불가합니다.
...
제31조 (기타 조항)
① 회사는 필요하면 특정 서비스나 기능의 전부 또는 일부를 11번가 사이트를 통해 미리 공지한 후 일시적 또는 영구적으로 수정하거나 중단할 수 있습니다.
② 각 당사자는 상대방의 서면 동의 없이 이 약관상의 권리와 의무를 제3자에게 양도하거나 처분할 수 없습니다.
③ 이 약관과 관련하여 당사자 간의 합의에 따라 추가로 작성된 계약서, 협정서, 통보서 등과 회사의 정책변경, 법령의 제·개정 또는 공공기관의 고시나 지침 등에 따라 회사가 11번가 사이트를 통해 공지하는 내용도 이용계약의 일부를 구성합니다.
...
■ 부칙
제1조 (시행일) 이 약관은 2014년 5월 23일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2014년 8월 29일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2014년 12월 18일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2015년 3월 27일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2015년 6월 25일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2015년 8월 1일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2015년 9월 16일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2015년 12월 4일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2016년 4월 26일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2016년 6월 24일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2016년 8월 8일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 2월 1일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 5월 8일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 7월 3일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 8월 22일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 9월 21일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 9월 25일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 9월 29일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 10월 26일부터 시행합니다. 
■ 부칙
제1조 (시행일) 이 약관은 2017년 11월 2일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2017년 12월 30일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 3월 1일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 3월 15일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 4월 1일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 9월 1일부터 시행합니다. 
■ 부칙
제1조 (시행일) 이 약관은 2018년 9월 18일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 10월 8일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 10월 29일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2018년 12월 19일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2019년 2월 8일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2019년 8월 15일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2019년 12월 9일부터 시행합니다.
■ 부칙
제1조 (시행일) 이 약관은 2019년 12월 19일부터 시행합니다.
		</textarea>
		<a name="sell"></a>
		<b>[필수] 판매이용약관 동의</b><br>
		<textarea rows="10" cols="100" readonly="readonly" style="width:100%;height:100;border:1;overflow:visible;text-overflow:ellipsis;">
...
④ 이 약관, 이용정책, 개별약관의 변경이 있으면 회사는 변경 내용의 효력발생일 7일 이전(다만, 판매회원에게 불리한 내용으로 변경할 때에는 30일 이전)에 해당 변경 사항을 판매회원툴에 공지하며, 판매회원이 변경된 약관, 이용정책, 개별약관에 동의하지 않으면 판매회원 탈퇴(이용계약의 해지)를 요청할 수 있으며, 변경 적용일까지 거부 의사를 표시하지 않으면 변경 약관, 이용정책, 개별약관에 동의한 것으로 간주합니다.
...
⑦ 구매이용약관상의 회원이 개인 판매회원으로 전환하고자 하거나 전환 없이 직접 개인 판매회원으로 상품 또는 용역을 판매하고자 한다면 회사는 해당 회원에게 신원확인 목적 등을 위하여 범용공인인증 또는 회사가 인정하는 신원확인 수단에 대한 자료를 요구할 수 있으며, 해당 회원은 범용공인인증서 등 회사가 요구하는 관련 자료를 회사가 요구하는 기한 내에 제출해야 합니다. 해당 회원이 본 규정을 지키지 않으면 회사는 해당 회원에 대하여 사이트 로그인, 상품 및 용역의 등록 또는 판매 등 회사가 제공하는 서비스의 이용을 제한할 수 있습니다.
...
② 서비스이용료는 판매가(판매회원이 정한 최초의 상품가격을 말합니다)에 회사가 정한 비율(이하 “서비스이용료율”이라 합니다)을 곱한 금액과 각종 판매촉진서비스(회사가 진행하는 광고 및 프로모션, 검색 등) 이용료를 포함합니다.
③ 서비스이용료와 서비스이용료율에 대한 자세한 내용은 판매회원툴에 공지하며 회사와 판매회원 간의 협의 또는 회사의 내부 사정에 따라 변경될 수 있습니다.
...
⑤ 상품을 반품 받은 판매회원은 배송비 정산, 사은품의 반환 확인 등이 필요하면 반품을 보류할 수 있고, 제4항에 따른 청약철회 제한 사유에 해당하는 등 정당한 사유가 있으면 반품을 거부할 수 있습니다. 판매회원이 반품보류 없이 반품수령일로부터 일정 기간(토요일 및 법정공휴일을 제외한 5영업일)이 지나도록 특별한 의사를 표시하지 않으면 회사는 환불에 필요한 조치를 할 수 있으며, 그 구체적인 사항에 대하여 회사는 합리적인 기준에 따라 정책을 정할 수 있습니다. 다만, 판매회원이 구매자의 청약철회를 제한하고자 그 사유를 증빙하여 환불보류를 요청하면 회사는 환불을 보류할 수 있습니다.
...
10. 판매회원이 판매한 각각의 상품에 대한 발송예정일까지 상품을 발송하지 않거나, 발송하지 않은 상품에 대한 운송장번호를 미리 입력하는 행위(가송장 사용 행위) 및 이에 준하는 행위
...
③ 회사는 제2항에서 정한 조치를 하기 이전에 필요하다고 판단하는 경우에는 해당 판매회원에 대하여 의견 청취 절차를 진행할 수 있으며, 판매회원은 1영업일(단, 회사가 판매회원의 소명 기간 연장 요청에 동의한 경우에는 그 기간) 이내에 소명하여야 합니다.
...
이 약관은 2019년 9월 1일부터 시행합니다.
		...
		<textarea rows="10" cols="100" readonly="readonly" style="width:100%;height:100;border:1;overflow:visible;text-overflow:ellipsis;">
11번가㈜ 귀중
11번가 서비스 이용을 위해 아래와 같이 개인정보를 수집·이용합니다.
고객님께서는 동의를 거부할 권리가 있으며, 동의 거부 시 11번가 서비스 이용이 불가합니다.

가. 개인회원

개인정보 수집 및 이용 목적	수집하는 개인정보 항목	개인정보의 보유 및 이용기간
이용자식별, 계약이행을 위한 연락, 서비스 이용에 따른 정보제공(고지사항 전달, 본인의사 확인, 서비스 관련 상담, 민원사항 처리, 카카오톡을 이용한 알림 정보 전송, 유의사항 등), 서비스이용 만족도 조사	아이디(ID), 비밀번호, 이름, 이동전화번호, 이메일	고객님의 개인정보는 서비스를 제공하는 기간 동안 보유 및 이용하며, 수집 및 이용목적이 달성되면 지체없이 파기합니다.
...
해외 상품 주문 시(구매대행 세관신고용) 본인확인	영문이름, 통관고유부호
상품과 경품 배송 시 배송지 주소 및 연락처 확인	이름, 주소, 연락처
출고지/반품/교환지 주소 관리	이름, 주소, 연락처
11번가 포인트 사용 시 확인
(글로벌해외개인셀러에 한함)	포인트비밀번호

나. 사업자회원

개인정보 수집 및 이용 목적	수집하는 개인정보 항목	개인정보의 보유 및 이용기간
이용자식별, 계약이행을 위한 연락, 서비스 이용에 따른 정보제공(고지사항 전달, 본인의사 확인, 서비스 관련 상담, 민원사항 처리, 유의사항 등), 서비스이용 만족도 조사	아이디(ID), 비밀번호, 대표자명, 담당자명, 사업자등록번호, 사업자 및 담당자 연락처, 이메일주소	고객님의 개인정보는 서비스를 제공하는 기간 동안 보유 및 이용하며, 수집 및 이용목적이 달성되면 지체없이 파기합니다.
단, 관계 법령에 따라 고객님의 개인정보를 보관하여야 하는 경우 회사는 해당 법령에서 정한 기간 동안 보관합니다. 또한 회사방침*에 의해 고객님의 개인정보를 보관하여야 하는 경우 회사는 고객님께 안내한 기간 동안 보관합니다.
* 회사방침에 따라 보관하는 경우
- 개별적으로 고객님의 동의를 받은 경우에는 고지한 기간 동안 보관
- 반복적인 회원탈퇴 및 재가입 방지를 위해 탈퇴 후 2개월간 개인정보 보관
